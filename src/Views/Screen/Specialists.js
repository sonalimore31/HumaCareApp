...
const Specialists = ({route, navigation}) => {
  const {data} = route.params.paramKey;
  console.log('DDDDDDDD>>>', data);
  console.log('DDDDDDDD>>>', data.name);
  console.log('DDDDDDDD>>>', data.education);
  console.log('Doct data>>', route.params.paramKey);
  return (
    <>
      <ScrollView>
        <View
        ...
        <View style={{marginTop: 10, marginLeft: 10}}>
          ...
          <Text>MDS - Periodnatics</Text>
          <Text>Bhuj dental college and hospital HP</Text>
          <Text>BDS - Implantologistics</Text>
          <Text>MNDAV Dental college and hospitail HP</Text>
